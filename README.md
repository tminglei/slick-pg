...
```scala
libraryDependencies += "com.github.tminglei" % "slick-pg_2.10" % "0.5.2.1"
```

> If you need `play-json` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" % "slick-pg_play-json_2.10" % "0.5.2.1"
```

> If you need `joda-time` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" % "slick-pg_joda-time_2.10" % "0.5.2.1"
```

> If you need `jts` geom support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" % "slick-pg_jts_2.10" % "0.5.2.1"
```

> If you need `json4s` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" % "slick-pg_json4s_2.10" % "0.5.2.1"
```

> If you need `threeten` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" % "slick-pg_threeten_2.10" % "0.5.2.1"
```

> If you need `spray-json` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" % "slick-pg_spray-json_2.10" % "0.5.2.1"
```
