...
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_joda-time" % "0.14.0"
```

> If you need `jts` geom support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_jts" % "0.14.0"
```
...
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_threeten" % "0.14.0"
```
...
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_play-json" % "0.14.0"
```

> If you need `spray-json` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_spray-json" % "0.14.0"
```

> If you need `argonaut json` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_argonaut" % "0.14.0"
```

> If you need `circe json` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_circe-json" % "0.14.0"
```
