...
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_jts" % "0.19.0"
or
libraryDependencies += "com.github.tminglei" %% "slick-pg_jts_lt" % "0.19.0"
```
...
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_spray-json" % "0.19.0"
```

> If you need `argonaut json` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_argonaut" % "0.19.0"
```

> If you need `circe json` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_circe-json" % "0.19.0"
```
