...
** _Tested on `PostgreSQL 11/12/13/14` with `Slick 3.4.1`._
...
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_joda-time" % "0.21.1"
```

> If you need `jts` geom support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_jts" % "0.21.1"
or
libraryDependencies += "com.github.tminglei" %% "slick-pg_jts_lt" % "0.21.1"
```

> If you need `json4s` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_json4s" % "0.21.1"
```
...
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_spray-json" % "0.21.1"
```

> If you need `argonaut json` support, pls append dependency:
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_argonaut" % "0.21.1"
```
...
```scala
libraryDependencies += "com.github.tminglei" %% "slick-pg_upickle-json" % "0.21.1"
```
