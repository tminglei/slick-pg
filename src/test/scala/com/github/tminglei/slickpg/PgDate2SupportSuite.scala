        ...
        DBIO.seq(
          Datetimes.result.head.map(
            ...
            r => {
              ...
              assert(r.dateTimeOffset.atZoneSameInstant(ZoneOffset.UTC) === testRec1.dateTimeOffset.atZoneSameInstant(ZoneOffset.UTC))
        ...
        DBIO.seq(
          DatetimesOption.result.head.map(
            ...
            r => {
              ...
              assert(r.dateTimeOffset.map(_.atZoneSameInstant(ZoneOffset.UTC)) === Some(testRec1.dateTimeOffset.atZoneSameInstant(ZoneOffset.UTC)))
