...
//
//  ///
////  import MyDate2PostgresDriver.api._
////
////  val db = Database.forURL(url = dbUrl, driver = "org.postgresql.Driver")
//
//  val dc = DatabaseConfig.forAnnotation[MyDate2PostgresDriver]
...
//    import dc.driver.plainAPI._
//
//    implicit val getDateBean = GetResult(r => (r.nextString(), r.nextLocalDate(), r.nextInt()))
//
//    def selectAllFoos = tsql"select * from foos"
////    Await.result(db.run(
////      DBIO.seq(
...
////    import MyDate2PostgresDriver.plainAPI._
////
