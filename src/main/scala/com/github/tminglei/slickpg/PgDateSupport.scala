...
trait PgDateSupport extends date.PgDateExtensions { driver: PostgresDriver =>
  ...
  trait DateTimeImplicits {
    ...
    implicit val timestampTZTypeMapper = new utils.GenericTypeMapper[Calendar]("timestamptz",
      PgDateSupport.parseCalendar, DatatypeConverter.printDateTime)
